...
drand randomness is available over [**HTTP**](./dev-guide-http-api), [**libp2p PubSub**](./dev-guide-pubsub-network) and gRPC.
...
If your application cannot use the libraries above, you can still use the [**drand-client CLI**](./dev-guide-drand-client-cli) or make requests to the [**HTTP API**](./dev-guide-http-api) endpoints. If you have created a client library or know of a client library not listed here, [**please let us know by opening an issue**](https://github.com/drand/website/issues/new).
...
- [**HTTP**](./dev-guide-http-api) client: [**https://pkg.go.dev/github.com/drand/drand/client/http**](https://pkg.go.dev/github.com/drand/drand/client/http)
- [**libp2p gossip**](./dev-guide-pubsub-network) client: [**https://pkg.go.dev/github.com/drand/drand/lp2p/client**](https://pkg.go.dev/github.com/drand/drand/lp2p/client)
